...
const TravelPlan = () => {
  ...
  return (
    <div
      id="travel-plan"
      className="max-w-7xl w-full self-center p-8 text-white"
    >
      <div className=" relative flex flex-col md:flex-row shadow-black shadow-2xl rounded-2xl">
        ...
        <div className="flex flex-col justify-between h-100 p-8 bg-[#263D47] rounded-br-2xl rounded-bl-2xl md:w-1/2 md:rounded-tr-2xl md:rounded-bl-none md:rounded-br-2xl">
